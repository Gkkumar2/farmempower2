...
export default function Navbar({ location }: Props) {
  ...
  return (
    <>
      <nav className="shadow-sm  sticky top-0 left-0 z-20 bg-gray-200">
        <div className="h-[80px] w-full flex justify-between items-center max-w-7xl px-3 mx-auto">
          ...
          <section className="flex items-center">
            <MdMyLocation
              ...
              className="text-2xl  text-green-800 hover:opacity-80 cursor-pointer m-3"
            />
            <MdOutlineLocationOn className="text-2xl text-red-900" />
            <p className="text-red-900 text-sm "> {location} </p>
            <div className="relative hidden md:flex m-3">
              {/* SearchBox */}
